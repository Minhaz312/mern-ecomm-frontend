  ...
  return (
    <div>
        ...
        <div className='w-1/2 bg-white rounded shadow-md mx-auto my-12 p-5'>
          <h1 className='text-4xl font-semibold text-slate-900 text-center my-5 uppercase'>create account</h1>
            <input type="text" placeholder='Enter Name' onChange={e=>setUserName(e.target.value.trim())} className='w-full mt-5 outline-none border-none bg-slate-100 px-4 py-2 focus:outline-slate-900/10' />
            ...
            <button className='w-full mt-5 mb-3 bg-slate-900 text-white font-semibold py-3 text-lg' onClick={handleCreateAccount}>{loading?"loading...":"Create"}</button>
            <p className='text-center text-lg font-semibold text-slate-500'>Already have account? <Link href="/user/login" className='text-blue-500'>Login</Link></p>
